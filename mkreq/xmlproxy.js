...
/* 
	Quick and dirty CORS proxy adapted from https://github.com/ctrezevant/node-form-inspector
	This is needed because we cant make cross domain resource requests from a browser tab
	thus, if this is served from the same domain, we gain that functionality while also keeping the security settings happy. 
*/
